...
class _OrganizationPayload implements OrganizationPayload {
  const _OrganizationPayload({required this.id, required this.name, required this.slug, this.logo, this.createdAt, this.updatedAt, this.metadata, this.members, this.invitations, this.teams});
...
@override final  List<OrganizationMember>? members;
@override final  List<OrganizationInvitation>? invitations;
@override final  List<OrganizationTeam>? teams;
