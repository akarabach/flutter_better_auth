...
class _OrganizationInvitation implements OrganizationInvitation {
  const _OrganizationInvitation({required this.id, required this.email, required this.role, required this.organizationId, required this.inviterId, required this.status, this.expiresAt, this.createdAt, this.organizationName, this.organizationSlug, this.inviterEmail, this.teamIds});
...
@override final  List<String>? teamIds;
