...
class _OrganizationMembersPage implements OrganizationMembersPage {
  const _OrganizationMembersPage({required this.members, required this.total});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrganizationMembersPage&&const DeepCollectionEquality().equals(other.members, members)&&(identical(other.total, total) || other.total == total));
}
