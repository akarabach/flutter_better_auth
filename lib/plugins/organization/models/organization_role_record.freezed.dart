...
class _OrganizationRoleRecord implements OrganizationRoleRecord {
  const _OrganizationRoleRecord({required this.id, required this.organizationId, required this.role, required this.permission, this.createdAt, this.updatedAt});
  factory _OrganizationRoleRecord.fromJson(Map<String, dynamic> json) => _$OrganizationRoleRecordFromJson(json);

@override final  String id;
@override final  String organizationId;
@override final  String role;
@override final  Map<String, dynamic> permission;
