...
class _TwoFactorBackupCodesResponse implements TwoFactorBackupCodesResponse {
  const _TwoFactorBackupCodesResponse({required this.status, this.backupCodes});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TwoFactorBackupCodesResponse&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.backupCodes, backupCodes));
}
