...
class _TwoFactorEnableResponse implements TwoFactorEnableResponse {
  const _TwoFactorEnableResponse({required this.totpURI, required this.backupCodes});
...
@override final  List<String> backupCodes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TwoFactorEnableResponse&&(identical(other.totpURI, totpURI) || other.totpURI == totpURI)&&const DeepCollectionEquality().equals(other.backupCodes, backupCodes));
}
