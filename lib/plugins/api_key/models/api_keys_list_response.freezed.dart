...
class _ApiKeysListResponse implements ApiKeysListResponse {
  const _ApiKeysListResponse({required this.apiKeys, required this.total, this.limit, this.offset});
  factory _ApiKeysListResponse.fromJson(Map<String, dynamic> json) => _$ApiKeysListResponseFromJson(json);

@override final  List<ApiKeyModel> apiKeys;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiKeysListResponse&&const DeepCollectionEquality().equals(other.apiKeys, apiKeys)&&(identical(other.total, total) || other.total == total)&&(identical(other.limit, limit) || other.limit == limit)&&(identical(other.offset, offset) || other.offset == offset));
}
